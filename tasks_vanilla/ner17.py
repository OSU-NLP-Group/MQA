...
def get_qa4re_spans2_named_mention(model, text, config, image, gold_ners):
    ...
    for o in O:
        ...
        if o != 'miscellaneous':
            ...
            pred_ners['misc'] = set(filter_ners)
            output_ners['misc'] = list(set(filter_ners))
...
def run_qa4span():
    ...
    sub_dataset = get_ner17_data(args.num_limit)
    save_dir = make_exp_dir('ner17_span', args.exp_name)
