...
def get_img2text():
    img2text = {}
    for url in ['./dataset/mee/annotations/text_multimedia_event.json', './MMUIE/dataset/mee/annotations/text_only_event.json']:
        for sample in read_json(url):
...
def read_img_annotations():
    img_anno = {}
    for url in ['./MMUIE/dataset/mee/annotations/image_only_event.json', './MMUIE/dataset/mee/annotations/image_multimedia_event.json']:
