...
def get_entity_typing(model, sent, img_path, span, config, temp, args, vis_processors, vis_process_func, call_model_engine_fn, device):
...
def run_qa4et():
    ...
    save_dir = make_exp_dir('ner17_et', args.exp_name)
